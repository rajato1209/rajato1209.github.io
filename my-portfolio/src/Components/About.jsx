    ...
    return (
        <div id="about">
            <Container>
              ...
              steps={["I'm a Full Stack Web Developer",, 2000, "I'm a MERN Developer", 1000]}
            ...
            />
                    ...
                    <div className='about_rightBox'>
                        <div>
                            <img src="https://avatars.githubusercontent.com/u/107460580?v=4" alt="" width='100%' height='100%'/>
                        </div>
                    </div>
                </div>
            </Container>
            <AboutMeWrapper data-aos='fade-right'>
                ...
                <div className='aboutSection'>
                    ...
                    <div className='left'>
                        ...
                        <p></p>
                        <p>Email: <span>rajato1209@gmail.com</span></p>
                    ...
                    <div className='right'>
                        ...
                        <p>My name is Rajat Kaswan, I am from Haryana. Frontend Developer with the ability to learn and collaborate in rapidly changing environments and compositions. Worked through 1000+ hours of miltery structure learning in JavaScript, Node.Js, React.Js, MongoDB, Express,ChakraUI,Redux, HTML5, and CSS3.</p>
